...
const SingleProductview = ({data}) => {
    ...
    const phone=[ "https://i01.appmifile.com/webfile/globalimg/products/pc/xiaomi-11t-pro-5g/pc.jpg","https://i02.appmifile.com/235_operator_sg/19/01/2022/de395496dc28adc2de942affcd067e8c.jpg",
     ...
     const handleincrement=()=>{
        let total=totalprice-(quantity*data.price)
            ...
            <Box sx={{ width: "60%", display: "flex", margin: "auto", marginTop: "20px" }}>
                ...
                <Box sx={{ overflow: "auto"}}>
                    ...
                    <Box sx={{ marginBottom: "25px" }}>
                        <h4>Quantity</h4>
                        <Box sx={{ display: "flex", marginTop: "20px", marginBottom: "15px" }}>
                            <button onClick={handledecrement} disabled={quantity == 0 ? true : false} style={{ border: "1px solid white", height: "20px" }}>-</button>
                            <button style={{ border: "1px solid white", height: "20px" }}>{quantity}</button>
                            <button onClick={handleincrement} style={{ border: "1px solid white", height: "20px" }}>+</button>
                        </Box>
                    </Box>
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", width: "90%", margin: "auto", marginBottom: "20px" }}>
                            <p>{data.title}</p>
                            <h5>{quantity*`${data.price}`}</h5>
                        </Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", width: "90%", margin: "auto", marginBottom: "20px" }}>
                            <p>Total</p>
                            <h4>{totalprice*quantity}</h4>
                        </Box>
                    </Box>
